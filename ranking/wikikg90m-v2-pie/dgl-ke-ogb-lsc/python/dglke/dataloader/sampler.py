...
class EvalDataset(object):
    ...
    def __init__(self, dataset, args):
        ...
        if dataset.test is not None:
            ...
            self.test_dev_dict = dataset.test_dev_dict
            self.num_test_dev = len(self.test_dev_dict['h,r->t']['hr'])
            self.test_challenge_dict = dataset.test_challenge_dict
            self.num_test_challenge_dict = len(self.test_challenge_dict['h,r->t']['hr'])
    ...
    def get_dicts(self, eval_type):
        ...
        elif eval_type == 'test-dev':
            return self.test_dev_dict
        elif eval_type == 'test-challenge':
